...
import DefaultProfilePicture from '../DefaultProfilePicture.jpeg'
             ...
             <Card raised={true} >
                 <CardContent style={{textAlign:"center"}}>
                    <img style={imageStyle} src={profilePictureSource} alt="Spotify Profile"></img>
                     <Typography align="center" color="textPrimary" variant="h5"> {props.content.display_name} </Typography>
                     <Typography align="center" color="textPrimary" variant="h5"> ID:{props.content.id} </Typography>
                     <Typography align="center" color="textPrimary" variant="h5"> Country:{props.content.country} </Typography>
                     <Typography align="center" color="textPrimary" variant="h5">Followers:{props.content.followers.total} </Typography>
                 </CardContent>
